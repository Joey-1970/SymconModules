<?
	...
	{ 
		...
		$arrayOptions[] = array("label" => "4 aufeinanderfolgende", "value" => 4);
		$arrayOptions[] = array("label" => "5 aufeinanderfolgende", "value" => 5);
		$arrayOptions[] = array("label" => "6 aufeinanderfolgende", "value" => 6);
		$arrayOptions[] = array("label" => "7 aufeinanderfolgende", "value" => 7);
		$arrayOptions[] = array("label" => "8 aufeinanderfolgende", "value" => 8);
		$arrayOptions[] = array("label" => "9 aufeinanderfolgende", "value" => 9);
		$arrayOptions[] = array("label" => "10 aufeinanderfolgende", "value" => 10);
		$arrayOptions[] = array("label" => "11 aufeinanderfolgende", "value" => 11);
		$arrayOptions[] = array("label" => "12 aufeinanderfolgende", "value" => 12);
		$arrayOptions[] = array("label" => "13 aufeinanderfolgende", "value" => 13);
		$arrayOptions[] = array("label" => "14 aufeinanderfolgende", "value" => 14);
