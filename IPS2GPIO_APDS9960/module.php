<?
	...
	{ 
		...
		$arrayOptions[] = array("label" => "2 sequenzielle", "value" => 2);
		$arrayOptions[] = array("label" => "3 sequenzielle", "value" => 3);
		$arrayOptions[] = array("label" => "4 sequenzielle", "value" => 4);
		$arrayOptions[] = array("label" => "5 sequenzielle", "value" => 5);
		$arrayOptions[] = array("label" => "6 sequenzielle", "value" => 6);
		$arrayOptions[] = array("label" => "7 sequenzielle", "value" => 7);
		$arrayOptions[] = array("label" => "8 sequenzielle", "value" => 8);
		$arrayOptions[] = array("label" => "9 sequenzielle", "value" => 9);
		$arrayOptions[] = array("label" => "10 sequenzielle", "value" => 10);
		$arrayOptions[] = array("label" => "11 sequenzielle", "value" => 11);
		$arrayOptions[] = array("label" => "12 sequenzielle", "value" => 12);
		$arrayOptions[] = array("label" => "13 sequenzielle", "value" => 13);
		$arrayOptions[] = array("label" => "14 sequenzielle", "value" => 14);
		$arrayOptions[] = array("label" => "15 sequenzielle", "value" => 15);
		...
		$arrayOptions[] = array("label" => "2 sequenzielle", "value" => 2);
		$arrayOptions[] = array("label" => "3 sequenzielle", "value" => 3);
		$arrayOptions[] = array("label" => "5 sequenzielle", "value" => 4);
		$arrayOptions[] = array("label" => "10 sequenzielle", "value" => 5);
		$arrayOptions[] = array("label" => "15 sequenzielle", "value" => 6);
		$arrayOptions[] = array("label" => "20 sequenzielle", "value" => 7);
		$arrayOptions[] = array("label" => "25 sequenzielle", "value" => 8);
		$arrayOptions[] = array("label" => "30 sequenzielle", "value" => 9);
		$arrayOptions[] = array("label" => "35 sequenzielle", "value" => 10);
		$arrayOptions[] = array("label" => "40 sequenzielle", "value" => 11);
		$arrayOptions[] = array("label" => "45 sequenzielle", "value" => 12);
		$arrayOptions[] = array("label" => "50 sequenzielle", "value" => 13);
		$arrayOptions[] = array("label" => "55 sequenzielle", "value" => 14);
		$arrayOptions[] = array("label" => "60 sequenzielle", "value" => 15);
