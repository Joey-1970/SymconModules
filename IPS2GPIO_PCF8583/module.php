<?
	...
	{ 
		...
		elseif ($this->ReadPropertyInteger("Function") == 2) {
			...
			$arrayElements[] = array("type" => "NumberSpinner", "name" => "PulseSetLightRain", "caption" => "Impulse bei dem die Assoziations-Variable auf leichter Regen gesetzt werden soll", "minimum" => 1, "visible" => true);
