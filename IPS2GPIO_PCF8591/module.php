<?
	...
	{ 
		...
		for ($i = 0; $i <= 3; $i++) {
			...
			$arrayElements[] = array("type" => "Select", "name" => "Function_".$i, "caption" => "Funktionsauswahl", "options" => $arrayOptions, "onChange" => 'IPS_RequestAction($id,"ChangeFunction",'.serialize(array($i, $this->ReadPropertyInteger("Function_".$i))).';)');
